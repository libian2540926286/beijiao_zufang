...
<html>
  ...
  <body>
    ...
    <td><a href="news/toAdminNews?newsId=${news.newsId}">查看</a>
    <a href="news/deleteNews?newsId=${news.newsId}">删除</a>
    </td>
    </tr>
    </c:forEach>  
    </tbody>
    ...
    <div class="pagin">
        ...
        <c:choose>
	      ...
	      <li class="paginItem"><a href="news/toallNews?pageNow=${page.pageNow-1}"><span class="pagepre"></span></a></li>
	      </c:when>
	      <c:when test="${pageNow-1<=0}">
        ...
        <c:choose>           
	     <c:when test="${page.pageTotalCount==0}">
	      <li class="paginItem"><a href="news/toallNews?pageNow=${page.pageNow}"><span class="pagenxt"></span></a></li>
	     </c:when>
	     <c:when test="${page.pageNow+1<page.pageTotalCount}">
	      <li class="paginItem"><a href="news/toallNews?pageNow=${page.pageNow+1}"><span class="pagenxt"></span></a></li>
	     </c:when>
	     <c:when test="${page.pageNow+1>=page.pageTotalCount}">
	      <li class="paginItem"><a href="news/toallNews?pageNow=${page.pageTotalCount}"><span class="pagenxt"></span></a></li>
	     </c:when>
	    </c:choose>
